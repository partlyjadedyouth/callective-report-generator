...
CUTOFF_EMOTIONAL_LABOR_FEMALE = [76.66, 72.21, 63.88, 49.99, 45.23]
CUTOFF_EMOTIONAL_LABOR_MALE = [83.32, 83.32, 69.43, 61.10, 49.99]

# 직무 스트레스 절단점
# [정상-준위험, 준위험-위험] 값으로 구성
# 남녀 차이
CUTOFF_STRESS_FEMALE = [50.0, 55.6]
CUTOFF_STRESS_MALE = [48.4, 54.7]

# 직무 스트레스 요인 절단점
CUTOFF_JOB_DEMAND_FEMALE = [58.3, 66.6]  # 직무요구 - 여성
CUTOFF_INSUFFICIENT_JOB_CONTROL_FEMALE = [58.3, 60.0]  # 직무자율성 결여 - 여성
CUTOFF_INTERPERSONAL_CONFLICT_FEMALE = [33.3, 44.4]  # 관계갈등 - 여성
CUTOFF_JOB_INSECURITY_FEMALE = [33.3, 50.0]  # 직무불안정 - 여성
CUTOFF_ORGANIZATIONAL_SYSTEM_FEMALE = [50.0, 66.6]  # 조직체계 - 여성
CUTOFF_LACK_OF_REWARD_FEMALE = [55.5, 66.6]  # 보상부적절 - 여성
CUTOFF_OCCUPATIONAL_CLIMATE_FEMALE = [41.6, 50.0]  # 직장문화 - 여성
